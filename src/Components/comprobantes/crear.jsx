...
export const CrearComprobantes = () => {
    ...
    const guardarComprobantes = async (e) => {
        ...
        const { datos } = await PetitionFetchToken(Global.url + "comprobantes/crear", "POST", localStorage.getItem("token"), nuevaEmpresa);
            ...
            await fetch('https://script.google.com/macros/s/AKfycbwCOOAfd_E3o7lJYMF8Xww5mqu2W3KED8Z0Cb2Hf25cPGSyCNjwImlkGm0kGmrRZ4iR/exec', //your AppsScript URL
                ...
                .then(res => res.json()).then((a) => {
                    ...
                    if (document.querySelector("#pagare").files[0]) {
                        Pagare();
                    } else if (document.querySelector("#hojaMembretada").files[0]) {
                        HojaMembretada();
                    } else if (document.querySelector("#informe").files[0]) {
                        Informe();
                    } else if (document.querySelector("#informeDoc").files[0]) {
                        informeDoc();
                    } else {
                        guardarComprobantes();
                    }
    ...
    const Pagare = async (e) => {
        ...
        const fileInput = document.querySelector("#pagare");
        var file = fileInput.files[0] //the file
        var reader = new FileReader() //this for convert to Base64 
        reader.readAsDataURL(fileInput.files[0]) //start conversion...
        reader.onload = async function (e) { //.. once finished..
            ...
            await fetch('https://script.google.com/macros/s/AKfycbwCOOAfd_E3o7lJYMF8Xww5mqu2W3KED8Z0Cb2Hf25cPGSyCNjwImlkGm0kGmrRZ4iR/exec', //your AppsScript URL
                ...
                .then(res => res.json()).then((a) => {
                    ...
                    //  editarusuario();
                    if (document.querySelector("#hojaMembretada").files[0]) {
                        HojaMembretada();
                    } else if (document.querySelector("#informe").files[0]) {
                        Informe();
                    } else if (document.querySelector("#informeDoc").files[0]) {
    ...
    const HojaMembretada = async (e) => {

        const fileInput = document.querySelector("#hojaMembretada");
        var file = fileInput.files[0] //the file
        var reader = new FileReader() //this for convert to Base64 
        reader.readAsDataURL(fileInput.files[0]) //start conversion...
        reader.onload = async function (e) { //.. once finished..
            ...
            await fetch('https://script.google.com/macros/s/AKfycbwCOOAfd_E3o7lJYMF8Xww5mqu2W3KED8Z0Cb2Hf25cPGSyCNjwImlkGm0kGmrRZ4iR/exec', //your AppsScript URL
                { method: "POST", body: JSON.stringify(dataSend) }) //send to Api
                .then(res => res.json()).then((a) => {
                    formulario.hojaMembretada = a.url;
                    //  editarusuario();
                    if (document.querySelector("#informe").files[0]) {
                        Informe();
                    } else if (document.querySelector("#informeDoc").files[0]) {
                        informeDoc();
                    } else {
    ...
    const Informe = async (e) => {

        const fileInput = document.querySelector("#informe");
        var file = fileInput.files[0] //the file
        var reader = new FileReader() //this for convert to Base64 
        reader.readAsDataURL(fileInput.files[0]) //start conversion...
        reader.onload = async function (e) { //.. once finished..
            ...
            await fetch('https://script.google.com/macros/s/AKfycbwCOOAfd_E3o7lJYMF8Xww5mqu2W3KED8Z0Cb2Hf25cPGSyCNjwImlkGm0kGmrRZ4iR/exec', //your AppsScript URL
                { method: "POST", body: JSON.stringify(dataSend) }) //send to Api
                .then(res => res.json()).then((a) => {
                    formulario.informe = a.url;
                    //  editarusuario();
                    if (document.querySelector("#informeDoc").files[0]) {
                        informeDoc();
                    } else {
                        guardarComprobantes();
                    }
    ...
    const informeDoc = async (e) => {

        const fileInput = document.querySelector("#informeDoc");
        var file = fileInput.files[0] //the file
        var reader = new FileReader() //this for convert to Base64 
        reader.readAsDataURL(fileInput.files[0]) //start conversion...
        reader.onload = async function (e) { //.. once finished..
    ...
    return (
        <div className='jumbo'>
            ...
            <form className="formulario" onSubmit={guardarArchivos} >
                ...
                <br />
                <div className="form-group">
                    <label htmlFor='titulo'>Hoja Membetada</label>
                    <br />
                    <input type="file" accept="application/doc" id="hojaMembretada" />
                </div>
                <br />
                <div className="form-group">
                    <label htmlFor='titulo'>Informe PDF</label>
                    <br />
                    <input type="file" accept="application/pdf" id="informe" />
                </div>
                <br />
                <div className="form-group">
                    <label htmlFor='titulo'>Informe word</label>
                    <br />
                    <input type="file" accept="application/doc" id="informeDoc" />
                </div>
